            ...
            <div className="flex-1 min-w-0">
              ...
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  layout
                  className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 sm:gap-5 lg:gap-6"
                >
                  {filteredAndSortedProducts.length > 0 ? (
                    ...
                    <motion.div 
                      ...
                      animate={{ opacity: 1, scale: 1 }}
                      className="col-span-full text-center py-12 sm:py-16 md:py-20"
                    >
